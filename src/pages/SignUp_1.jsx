          ...
          <div>
            ...
            <div className="flex space-x-4">
              <button
                ...
                className={`flex-1 p-3 mb-2 rounded ${formData.gender === '남자' ? 'bg-main01 text-white' : 'bg-gray-200'}`}
              >
                남자
              </button>
              <button
                ...
                className={`flex-1 p-3 mb-2 rounded ${formData.gender === '여자' ? 'bg-main01 text-white' : 'bg-gray-200'}`}
              >
                여자
              </button>
              <button
                ...
                className={`flex-1 p-3 mb-2 rounded ${formData.gender === '기타' ? 'bg-main01 text-white' : 'bg-gray-200'}`}
              >
                기타
              </button>
            </div>
